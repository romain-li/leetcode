...
DIFFICULTY = 'Medium'
URL = 'https://oj.leetcode.com/problems/course-schedule-ii/'
BOOK = False
PROBLEM = r"""There are a total of _n_ courses you have to take, labeled from `0` to `n -
1`.
...
adjacency matrices. Read more about [how a graph is
represented](https://www.khanacademy.org/computing/computer-science/algorithms
/graph-representation/a/representing-graphs).
