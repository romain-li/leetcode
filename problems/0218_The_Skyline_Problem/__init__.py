...
DIFFICULTY = 'Hard'
URL = 'https://oj.leetcode.com/problems/the-skyline-problem/'
BOOK = False
PROBLEM = r"""A city's skyline is the outer contour of the silhouette formed by all the
...
[ ![Buildings](http://i62.tinypic.com/2a0e4qu.jpg)
](http://tinypic.com?ref=2a0e4qu) [ ![Skyline
Contour](http://i61.tinypic.com/2vtdqtf.jpg) ](http://tinypic.com?ref=2vtdqtf)
...
is guaranteed that `0 ≤ Li, Ri ≤ INT_MAX`, `0 , and `Ri - Li &gt; 0`. You may
